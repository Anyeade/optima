    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Welcome back! Here's what's happening with your processes.</p>
        </div>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <div className="flex space-x-2">
                    <div className="flex-1 font-mono text-sm bg-accent p-3 rounded border">
                      {apiKey}
                    </div>
                  ...
                  {processes.map((process) => (
                    <div key={process.id} className="flex items-center justify-between p-4 border rounded-lg">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground capitalize">{process.status}</p>
                      </div>
