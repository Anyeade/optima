...
-- Insert sample processes for demonstration
...
('00000000-0000-0000-0000-000000000000', '/api/v1/processes/analyze', 'POST', 200, 1250),
('00000000-0000-0000-0000-000000000000', '/api/v1/processes/analyze', 'POST', 200, 980),
('00000000-0000-0000-0000-000000000000', '/api/v1/automation/trigger', 'POST', 200, 2100),
('00000000-0000-0000-0000-000000000000', '/api/v1/processes/insights', 'GET', 200, 450),
('00000000-0000-0000-0000-000000000000', '/api/v1/processes/analyze', 'POST', 200, 1100);

-- Insert sample automation jobs
INSERT INTO automation_jobs (user_id, process_id, job_type, status, progress, result) VALUES
(
  '00000000-0000-0000-0000-000000000000',
  (SELECT id FROM processes WHERE name = 'Customer Onboarding' LIMIT 1),
...
(
  '00000000-0000-0000-0000-000000000000',
  (SELECT id FROM processes WHERE name = 'E-commerce Checkout' LIMIT 1),
